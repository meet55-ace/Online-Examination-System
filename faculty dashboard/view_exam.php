...
$questionQuery = "SELECT question, op1, op2, op3, op4, correct_option, ques_mark FROM question WHERE exam_id = ?";
...
<body>
    <div class="container mt-5">
        ...
        <div class="text-center mt-4">
            <a href="previousExam.php" class="btn btn-secondary">&laquo; Back</a>
        </div>
    </div>
</body>
</html>
